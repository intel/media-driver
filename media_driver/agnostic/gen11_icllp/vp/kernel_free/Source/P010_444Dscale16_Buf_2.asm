...
(f1.0)   mac (1|M0)               r23.3<1>:f    r23.1<0;1,0>:f    2.0:f           
         ...
         mul (16|M0)              acc0.0<1>:f   r104.0<8;8,1>:f   65535.0:f       
         mov (16|M0)              (sat)r96.0<1>:ud  acc0.0<8;8,1>:f             
         mul (16|M0)              acc0.0<1>:f   r108.0<8;8,1>:f   65535.0:f       
         mov (16|M0)              (sat)r100.0<1>:ud  acc0.0<8;8,1>:f            
         mul (16|M0)              acc0.0<1>:f   r110.0<8;8,1>:f   65535.0:f       
         ...
         mul (16|M0)              acc0.0<1>:f   r106.0<8;8,1>:f   65535.0:f       
