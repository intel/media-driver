...
(f1.0)   mac (1|M0)               r23.3<1>:f    r26.4<0;1,0>:f    -8.0:f          
         ...
         mul (16|M0)              acc0.0<1>:f   r55.0<8;8,1>:f    65535.0:f       
         mov (16|M0)              (sat)r46.0<1>:ud  acc0.0<8;8,1>:f             
         mul (16|M0)              acc0.0<1>:f   r57.0<8;8,1>:f    65535.0:f       
         mov (16|M0)              (sat)r48.0<1>:ud  acc0.0<8;8,1>:f             
         mul (16|M0)              acc0.0<1>:f   r59.0<8;8,1>:f    65535.0:f       
         mov (16|M0)              (sat)r50.0<1>:ud  acc0.0<8;8,1>:f             
         mul (16|M0)              acc0.0<1>:f   r61.0<8;8,1>:f    65535.0:f       
