...
(f1.0)   mac (1|M0)               r23.3<1>:f    r23.1<0;1,0>:f    2.0:f           
         ...
         mul (16|M0)              acc0.0<1>:f   r72.0<8;8,1>:f    65535.0:f       
         mov (16|M0)              (sat)r64.0<1>:ud  acc0.0<8;8,1>:f             
         mul (16|M0)              acc0.0<1>:f   r76.0<8;8,1>:f    65535.0:f       
         mov (16|M0)              (sat)r68.0<1>:ud  acc0.0<8;8,1>:f             
         mul (16|M0)              acc0.0<1>:f   r78.0<8;8,1>:f    65535.0:f       
         ...
         mul (16|M0)              acc0.0<1>:f   r74.0<8;8,1>:f    65535.0:f       
